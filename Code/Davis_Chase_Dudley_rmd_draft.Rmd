...
Master_Data_Frame %>%
  ...
  geom_errorbar(aes(ymin = mean_conc_nitrate - standard_error_N, ymax = mean_conc_nitrate + standard_error_N), width = .2)+
  facet_wrap("year")
...
Master_Data_Frame %>%
  ...
  geom_col(position="dodge")+
  geom_errorbar(aes(ymin = mean_veg_cover - standard_error_V, ymax = mean_veg_cover + standard_error_V), width = .2)+
  facet_wrap("year")
