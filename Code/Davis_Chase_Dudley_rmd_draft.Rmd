...
Total_Nitrate_Combined_One_Col <- bind_rows(Nitrate_BIGC_2019, Nitrate_BIGC_2021, Nitrate_BLUE_2019, Nitrate_BLUE_2021, Nitrate_LECO_2019, Nitrate_LECO_2021)

Mean_Nitrate_Combined <- Total_Nitrate_Combined_One_Col %>% 
  group_by(siteID, year) %>% 
  summarize(mean_conc = mean(surfWaterNitrateMean))
...
Code Template Bank Below____________________
